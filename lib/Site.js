...
Site.prototype.createPage = function (config) {
  ...
  return new Page({
    ...
    asset: {
      ...
      siteNavJs: path.relative(path.dirname(resultPath),
                               path.join(this.siteAssetsDestPath, 'js', 'site-nav.js')),
...
Site.prototype.collectUserDefinedVariablesMap = function () {
  ...
  Object.keys(this.baseUrlMap).forEach((base) => {
    ...
    Object.assign(userDefinedVariables, glyphiconsMap, markbindVariable);
