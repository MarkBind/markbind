...
/**
 * Records the front matter page into this.frontMatter
 * Removes the front matter page before it is rendered
  ...
  if (frontMatter.length) {
    ...
    if (this.titlePrefix) {
      this.frontMatter.title = this.frontMatter.title
        ? this.titlePrefix + TITLE_PREFIX_SEPARATOR + this.frontMatter.title : this.titlePrefix;
    }
  } else {
    // Page is addressable but no front matter specified
    const formattedTitle = this.titlePrefix
      ? this.titlePrefix + (this.title ? TITLE_PREFIX_SEPARATOR + this.title : '') : this.title;
    this.frontMatter = {
      src: this.src,
