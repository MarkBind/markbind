...
<!--      shift-cross-axis-->
<!--    >-->
<!--      &lt;!&ndash; floating-vue triggers must be elements that receive mouse events,
hence an empty @click &ndash;&gt;-->
<!--      <span v-if="!isInput" @click.stop>-->
<!--        <slot></slot>-->
<!--      </span>-->
<!--      &lt;!&ndash; However, input elements are handled separately
as they will lose focus when wrapped in a span &ndash;&gt;-->
<!--      <slot v-else></slot>-->
<!--      <template #popper>-->
