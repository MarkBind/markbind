...
/**
 * Compiles a Vue page template into a JavaScript module containing the render function
 * and saves it as a script file so that the browser can access the page render function to
...
async function compileVuePageAndCreateScript(
  ...
  // Compile Vue Page Render Module, returns module that includes render() function.
