...
class Page {
  ...
  addLayoutScriptsAndStyles() {
    ...
    this.includedFiles.add(path.join(process.cwd(), '_markbind', 'layouts', this.layout, 'scripts.js'));
    this.includedFiles.add(path.join(process.cwd(), '_markbind', 'layouts', this.layout, 'styles.css'));
  }
