...
class Site {
   ...
   */
  async initSite(templateConfig, isConversion) {
   ...
   */
  addDefaultLayoutFile(njkFile, njkObject) {
   ...
   */
  createNjkObjects({ njkSubs, hasAutoSiteNav, siteNavIgnore }) {
    const njkObject = {};
   ...
   *
   */
  async addTemplateLayoutSettingsToSiteConfig({ pageConfigs }) {
   ...
   */
  static async writeToSiteConfig(config, configPath, pageConfigs) {
