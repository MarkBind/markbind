 ...
 */
var _a = require('nunjucks'), Environment = _a.Environment, Template = _a.Template, lib = _a.lib;
/* eslint-disable */
var noopTmplSrc = {
    type: 'code',
    obj: {
    ...
    if (name instanceof Template) {
        ...
        for (var i = 0; i < this.loaders.length; i++) {
            ...
            if (tmpl) {
                ...
                Object.entries(loader.pathsToNames).forEach(function (_a) {
                    var fullPath = _a[0], templateName = _a[1];
                    if (name === templateName) {
                        // Emit the load event
                        _this.emit('load', name, {
                            src: tmpl,
                            path: fullPath,
