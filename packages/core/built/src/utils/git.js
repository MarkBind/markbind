...
module.exports = {
     ...
     */
    getRemoteBranchFile: function (simpleGit, type, remote, branch, fileName) {
        return __awaiter(this, void 0, void 0, function () {
            var catFileTarget, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        catFileTarget = remote + "/" + branch + ":" + fileName;
                        return [4 /*yield*/, simpleGit.catFile([type, catFileTarget])];
     ...
     */
    getRemoteUrl: function (simpleGit, remote) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, simpleGit.remote(['get-url', remote])];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        e_2 = _a.sent();
                        return [2 /*return*/, undefined];
