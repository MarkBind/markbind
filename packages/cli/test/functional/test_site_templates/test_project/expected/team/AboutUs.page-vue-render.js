...
with(this){return _c('p',[_v("We are a team based in "),_c('a',{attrs:{"href":"#project-team"}},[_v("Organisation A")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("You can reach us at the email "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("organisationa@gmail.sg")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.2")]),_v("]")])])])}
}];
