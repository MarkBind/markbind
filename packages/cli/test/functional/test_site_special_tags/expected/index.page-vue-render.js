...
with(this){return _c('p',[_v("There should be no text between this and the next "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("<hr>")]),_v(" tag in the browser, since it is a "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("<script>")]),_v(" tag."),_c('br'),_v("\nThere should be an alert with the value of 2 as well.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("There should be no text between this and the next "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("<hr>")]),_v(" tag in the browser, since it is a "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("<style>")]),_v(" tag.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("There should be text between this and the next "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("<hr>")]),_v(" tag, since it is a special tag.\nAll text should appear in the browser window as a single line,\nsave for the comment which the browser still interprets. (but will be in the expected output)")])}
},function anonymous(
) {
with(this){return _c('p',[_v("This has the same content has the previous test, but it is "),_c('strong',[_v("not")]),_v(" a special tag.\nThe html comment "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("<!-- -->")]),_v(" should disappear in the expected output.\nThe line "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("some text")]),_v(" should appear as per normal, and not wrapped by a paragraph since\na html tag precedes it without a blank line.\nThe other lines should be parsed as markdown paragraphs, as per commonmark spec.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("There are two self closing special tags below, which should display nothing, but are present in the output.\nThere is then one special tag with both and opening and closing tag with some text in it ("),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("lorem ipsum...")]),_v(").\nNote that script and style tags are still not allowed to be self-closing, as per the html5 spec.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("This should pass the htmlparser2 patch but not the markdown-it patch as it violates commonmark."),_c('br'),_v("\nAll lines after the first "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("!success")]),_v(" wrapping text will be wrapped in a "),_c('code',{pre:true,attrs:{"class":"no-line-numbers hljs inline no-lang"}},[_v("<p>...</p>")]),_v(" tag as it is\nparsed as a markdown paragraph.")])}
}];
