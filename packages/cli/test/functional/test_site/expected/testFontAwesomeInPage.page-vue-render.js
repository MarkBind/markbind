...
with(this){return _c('p',[_v("A font-awesome icon is supposed to appear here ---> "),_c('span',{staticClass:"fas fa-code-branch",attrs:{"aria-hidden":"true"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("There is one font-awesome icon in this page content.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Open up console. Only font-awesome stylesheet should be loaded!")])])}
}];
