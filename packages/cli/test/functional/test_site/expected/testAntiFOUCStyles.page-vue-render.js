...
<navbar type="dark">
  ...
  <dropdown class="nav-link"><template #header>Dropdown</template>
    <li><a class="dropdown-item" href="/">Dropdown One</a></li>
    <li><a class="dropdown-item" href="/">Dropdown Two</a></li></dropdown></navbar>

<p><strong>Test dropdown in body with text and class attributes</strong></p>
<dropdown class="test-class"><template #header>Test One</template>
  <li><a class="dropdown-item" href="/">Dropdown One</a></li>
  <li><a class="dropdown-item" href="/">Dropdown Two</a></li></dropdown>
