...
<li class="site-nav-custom-list-item site-nav-list-item-2">Line break item 2 📘</li>
  ...
  <div id="content-wrapper">
    ...
    <h1 id="images">Images<a class="fa fa-anchor" href="#images" onclick="event.stopPropagation()"></a></h1>
<h2 id="alt">Alt<a class="fa fa-anchor" href="#alt" onclick="event.stopPropagation()"></a></h2>
<p>The label of the image will be used as the &quot;alt&quot;: <a href="https://markbind.org/images/logo-lightbackground.png" target="_self"><img src="https://markbind.org/images/logo-lightbackground.png" alt="caption" class="img-fluid"></a></p>
<h2 id="dimension">Dimension<a class="fa fa-anchor" href="#dimension" onclick="event.stopPropagation()"></a></h2>
<p>This image has a width of 100px: <a href="https://markbind.org/images/logo-lightbackground.png" target="_self"><img src="https://markbind.org/images/logo-lightbackground.png" alt class="img-fluid" width="100"></a></p>
<p>This image has a width of 200px: <a href="https://markbind.org/images/logo-lightbackground.png" target="_self"><img src="https://markbind.org/images/logo-lightbackground.png" alt class="img-fluid" width="200"></a></p>
<h2 id="linkify">Linkify<a class="fa fa-anchor" href="#linkify" onclick="event.stopPropagation()"></a></h2>
<p>AutoWrap image with link to the image URL:</p>
<p><a href="https://octodex.github.com/images/minion.png" target="_self"><img src="https://octodex.github.com/images/minion.png" alt="Minion" class="img-fluid"></a></p>
<p>Does not autoWrap image with link to the image URL if already wrapped with a link:</p>
<p><a href="http://google.com"><img src="https://octodex.github.com/images/minion.png" alt="Minion" class="img-fluid"></a></p>
  </div>
