...
<p>The Bootstrap scrollspy related classes (i.e data-bs-target, data-bs-spy, data-bs-offset) should not be applie to the body element in the generated HTML
as there are no navigable headings in the page.</p>
  </div>
  <overlay-source id="page-nav" tag-name="nav" to="page-nav">
    <div class="nav-component slim-scroll">
      <a class="navbar-brand page-nav-title" href="#" v-pre>Title</a>
