...
<div class="page-nav-print d-none d-print-block" v-pre></div>
<h1 id="h1">H1<a class="fa fa-anchor" href="#h1" onclick="event.stopPropagation()"></a></h1>
<p>Some content</p>
<h2 id="h2">H2<a class="fa fa-anchor" href="#h2" onclick="event.stopPropagation()"></a></h2>
<p>Some more content</p>
<div class="page-nav-print d-none d-print-block" v-pre>
This is another printed pageNav
</div>
  </div>
  <overlay-source id="page-nav" tag-name="nav" to="page-nav">
    <div class="nav-component slim-scroll">
      <a class="navbar-brand page-nav-title" href="#" v-pre>PageNav can be printed</a>
<overlay-source id="mb-page-nav" tag-name="nav" to="mb-page-nav" class="nav nav-pills flex-column my-0 small no-flex-wrap">
<a class="nav-link py-1" href="#h1" v-pre>H1&#x200E;</a>
<nav class="nav nav-pills flex-column my-0 nested no-flex-wrap">
<a class="nav-link py-1" href="#h2" v-pre>H2&#x200E;</a>
</nav>
