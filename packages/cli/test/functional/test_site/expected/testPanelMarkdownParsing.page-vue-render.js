...
<li class="site-nav-custom-list-item site-nav-list-item-2">Line break item 2 📘</li>
  ...
  <div id="content-wrapper">
    ...
    <p>markdown pre text <strong>immediately</strong> prepending a component, without an empty line after</p>
<panel>
line 1 which behaves as per normal ( empty line still counts )
<p>lines 3 onward are 'placed' inside of the component as it is a normal panel (block element)
...
...</p></panel>
<p>markdown pre text <strong>immediately</strong> prepending a component, without an empty line after</p>
<panel><template #header><p>test for minimized as part of attribute value</p></template><template #_alt><p>test</p></template>
line 1 which behaves as per normal ( empty line still counts )
<p>lines 3 onward are 'placed' inside of the component as it is a normal panel (block element)
...
...</p></panel>
...
<panel minimized>
line 1 which behaves as per normal ( empty line still counts )</panel></p>
<p>lines 3 onward are 'placed' outside of the component as it is a minimized panel (inline element)
...
...</p>

<p>markdown pre text <strong>immediately</strong> prepending a component, without an empty line after
<panel minimized><template #header><p>test minimized placed extreme right</p></template><template #_alt><p>test</p></template>
line 1 which behaves as per normal ( empty line still counts )</panel></p>
<p>lines 3 onward are 'placed' outside of the component as it is a minimized panel (inline element)
...
...</p>
...
<p>markdown pre text <strong>immediately</strong> prepending a component, without an empty line after
<panel minimized><template #header><p>test minimized placed between attributes</p></template><template #_alt><p>test</p></template>
line 1 which behaves as per normal ( empty line still counts )</panel></p>
<p>lines 3 onward are 'placed' outside of the component as it is a minimized panel (inline element)
...
...</p>
...
<p>markdown pre text <strong>immediately</strong> prepending a component, without an empty line after
<panel minimized><template #header><p>test minimized placed extreme left</p></template><template #_alt><p>hi</p></template>
line 1 which behaves as per normal ( empty line still counts )</panel></p>
<p>lines 3 onward are 'placed' outside of the component as it is a minimized panel (inline element)
...
...</p>
