...
<p>Since a page nav title has been added to <code class="line-numbers hljs inline no-lang" v-pre>frontmatter</code>, it should show in page nav component/section of the page.</p>
<p>Hence, the separator i.e., <code class="line-numbers hljs inline no-lang" v-pre>border-left: ...</code> should now be present in the above mentioned component.</p>
  </div>
  <overlay-source id="page-nav" tag-name="nav" to="page-nav">
    <div class="nav-component slim-scroll">
      <a class="navbar-brand page-nav-title" href="#" v-pre>Title in Page Nav</a>
