...
with(this){return _c('h1',{attrs:{"id":"heading-fragment-with-leading-spaces-and-newline"}},[_c('span',{staticClass:"anchor",attrs:{"id":"heading-fragment-with-leading-spaces-and-newline"}}),_v("Heading "),_c('div',[_c('pre',[_c('code',{pre:true},[_v("Fragment with leading spaces and newline\n")])])]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#heading-fragment-with-leading-spaces-and-newline","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("id")]),_v(" for the above heading should be "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("heading-fragment-with-leading-spaces-and-newline")]),_v(" in total.\nThis test ensures heading ids are assigned last (e.g. after "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("<include />")]),_v("s are processed).")])}
},function anonymous(
) {
