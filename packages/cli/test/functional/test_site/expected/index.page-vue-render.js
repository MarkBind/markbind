...
with(this){return _c('div',{staticClass:"site-nav-top"},[_c('div',{staticClass:"font-weight-bold mb-2",staticStyle:{"font-size":"1.25rem"}},[_c('div',[_c('h2',{attrs:{"id":"default-layout"}},[_c('span',{staticClass:"anchor",attrs:{"id":"default-layout"}}),_v("Default Layout"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#default-layout","onclick":"event.stopPropagation()"}})])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("<markdown>")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("<md>")]),_v(" elements")])])}
},function anonymous(
) {
...
with(this){return _c('span',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("<md>")]),_v(" elements allow inline-level markdown even in a non-markdown token.\nHence, the contained markdown should be parsed and output as is, without any parsing errors.\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("</invalid>")]),_v(".\n")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test footnotes")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Nunjucks SetExt")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Variables that reference another variable")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Global Variables can be referenced in {% set %}")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Global Variables should override {% set %}")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test Page Variable and Included Variable Integrations")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_c('strong',[_v("Outer Page Variable Should Not Leak Into Inner Pages")])]),_v(" "),_c('p',[_v("Outer Page Variable Should Not Leak Into Inner Pages")])])}
},function anonymous(
) {
with(this){return _c('h1',{attrs:{"id":"heading-with-multiple-keywords"}},[_c('span',{staticClass:"anchor",attrs:{"id":"heading-with-multiple-keywords"}}),_v("Heading with multiple keywords"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#heading-with-multiple-keywords","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('span',{staticClass:"keyword"},[_v("keyword 1")]),_v(" "),_c('span',{staticClass:"keyword"},[_v("keyword 2")])])}
},function anonymous(
) {
with(this){return _c('h1',{attrs:{"id":"heading-with-keyword-in-panel"}},[_c('span',{staticClass:"anchor",attrs:{"id":"heading-with-keyword-in-panel"}}),_v("Heading with keyword in panel"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#heading-with-keyword-in-panel","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Panel with heading with keyword")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Expanded panel without heading with keyword")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Unexpanded panel with heading with keyword")])])}
},function anonymous(
) {
with(this){return _c('h1',{attrs:{"id":"heading-with-included-keyword"}},[_c('span',{staticClass:"anchor",attrs:{"id":"heading-with-included-keyword"}}),_v("Heading with included keyword"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#heading-with-included-keyword","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_c('span',{staticClass:"keyword"},[_v("included keyword")])])])}
},function anonymous(
) {
with(this){return _c('div',[_c('h1',{attrs:{"id":"included-heading"}},[_c('span',{staticClass:"anchor",attrs:{"id":"included-heading"}}),_v("Included Heading"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#included-heading","onclick":"event.stopPropagation()"}})])])}
},function anonymous(
) {
with(this){return _c('h1',{attrs:{"id":"heading-with-nested-keyword"}},[_c('span',{staticClass:"anchor",attrs:{"id":"heading-with-nested-keyword"}}),_v("Heading with nested keyword"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#heading-with-nested-keyword","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('div',[_c('div',[_c('div',[_c('span',{staticClass:"keyword"},[_v("nested keyword")])])])])}
},function anonymous(
) {
with(this){return _c('h1',{attrs:{"id":"heading-with-hidden-keyword"}},[_c('span',{staticClass:"anchor",attrs:{"id":"heading-with-hidden-keyword"}}),_v("Heading with hidden keyword"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#heading-with-hidden-keyword","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('span',{staticClass:"keyword d-none"},[_v("invisible keyword")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_c('strong',[_v("Div with frontmatter shown tag")])]),_v(" "),_c('div',{attrs:{"tags":"tag-frontmatter-shown"}},[_v("\nDiv with shown tag\n")]),_v(" "),_c('p',[_c('strong',[_v("Div with site shown tag")])]),_v(" "),_c('div',{attrs:{"tags":"tag-site-shown"}},[_v("\nDiv with site shown tag\n")]),_v(" "),_c('p',[_c('strong',[_v("Div with multiple tags")])]),_v(" "),_c('div',{attrs:{"tags":"tag-site-shown tag-other"}},[_v("\nDiv with multiple tags\n")]),_v(" "),_c('p',[_c('strong',[_v("Div with hidden tag (Hidden)")])]),_v(" "),_c('div',[_c('p',[_c('strong',[_v("Div with tag in included file")])]),_v(" "),_c('div',{attrs:{"tags":"tag-included-file"}},[_v("\nDiv with tag in included file\n")])]),_v(" "),_c('p',[_c('strong',[_v("Div with tag matching general tag")])]),_v(" "),_c('div',{attrs:{"tags":"tag-exp-shown"}},[_v("\nDiv with tag matching general tag\n")]),_v(" "),_c('p',[_c('strong',[_v("Div with tag matching general tag and specific tag (Hidden)")])]),_v(" "),_c('p',[_c('strong',[_v("Div with tag matching front matter tag overridden by matching site tag")])]),_v(" "),_c('div',{attrs:{"tags":"tag-site-override-shown"}},[_v("\nDiv with tag matching front matter tag overridden by matching site tag\n")]),_v(" "),_c('p',[_c('strong',[_v("Div with tag matching general front matter tag not overridden by matching specific site tag (Hidden)")])]),_v(" "),_c('p',[_c('strong',[_v("Div with tag matching general front matter tag overridden by matching specific site tag")])]),_v(" "),_c('div',{attrs:{"tags":"tag-site-override-shown"}},[_v("\nDiv with tag matching general front matter tag overridden by matching specific site tag\n")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Normal include")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"establishing-requirements"}},[_c('span',{staticClass:"anchor",attrs:{"id":"establishing-requirements"}}),_v("Establishing Requirements"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#establishing-requirements","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"brainstorming"}},[_c('span',{staticClass:"anchor",attrs:{"id":"brainstorming"}}),_v("Brainstorming"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#brainstorming","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"user-surveys"}},[_c('span',{staticClass:"anchor",attrs:{"id":"user-surveys"}}),_v("User surveys"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#user-surveys","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"focus-groups"}},[_c('span',{staticClass:"anchor",attrs:{"id":"focus-groups"}}),_v("Focus groups"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#focus-groups","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include segment")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Boilerplate include")])])}
},function anonymous(
) {
with(this){return _c('h1',{attrs:{"id":"path-within-the-boilerplate-folder-is-separately-specified"}},[_c('span',{staticClass:"anchor",attrs:{"id":"path-within-the-boilerplate-folder-is-separately-specified"}}),_v("Path within the boilerplate folder is separately specified"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#path-within-the-boilerplate-folder-is-separately-specified","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Also, the boilerplate file name (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("inside.md")]),_v(") and the file that it is supposed to act as ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("notInside.md")]),_v(") can be different.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("This file should behaves as if it is in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("requirements")]),_v(" folder:")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Nested include")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('ol',[_c('li',[_c('strong',[_v("Establishing requirements")]),_v(": "),_c('span',[_v("Requirements gathering, requirements elicitation, requirements analysis,\nrequirements capture are some of the terms commonly "),_c('strong',[_v("and")]),_v(" interchangeably used to represent the activity\nof understanding what a software product should do.")])]),_v(" "),_c('li',[_c('strong',[_v("Specifying requirements")]),_v(": "),_c('span',[_v("As we establish requirements, they should be recorded in some way for future reference,\nusually called a requirement specification. Furthermore, it is advisable to show these requirements to stakeholders,\nand refine requirements based on their feedback. The next phase is to convert requirements into a product\nspecification that specifies how the product will address the requirements. ")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("HTML include")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_v("This is a HTML document")]),_v(" "),_c('span',[_v("It is "),_c('strong',[_v("possible")]),_v(" to use Markdown in HTML")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Mbd, Mbdf include")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_c('em',[_v("MarkBind supports .mbd files.")])])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MarkBind supports .mbdf files.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include from another Markbind site")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_v("This is a page from another Markbind site.")]),_v(" "),_c('h2',{attrs:{"id":"feature-list"}},[_c('span',{staticClass:"anchor",attrs:{"id":"feature-list"}}),_v("Feature list"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#feature-list","onclick":"event.stopPropagation()"}})]),_v(" "),_c('p',[_v("It is a list of features (or functionalities) grouped according to some criteria such as priority\n(e.g. must-have, nice-to-have, etc. ), order of delivery, object or process related\n(e.g. order-related, invoice-related, etc.).\nHere is a sample feature list from Minesweeper (only a brief description has been provided to save space).")]),_v(" "),_c('ol',[_c('li',[_v("Basic play – Single player play.")]),_v(" "),_c('li',[_v("Difficulty levels – Additional Medium and Advanced levels.")]),_v(" "),_c('li',[_v("Versus play – Two players can play against each other.")]),_v(" "),_c('li',[_v("Timer – Additional fixed time restriction on the player.")])]),_v(" "),_c('div',{attrs:{"id":"image"}},[_c('img',{attrs:{"src":"/test_site/sub_site/images/I'm not allowed to use my favorite tool.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("IMG tags:\n"),_c('img',{attrs:{"src":"/test_site/sub_site/images/I'm not allowed to use my favorite tool.png"}}),_v(" "),_c('img',{attrs:{"src":"/test_site/sub_site/images/I'm not allowed to use my favorite tool.png"}}),_v(" "),_c('img',{attrs:{"src":"/test_site/sub_site/images/I'm not allowed to use my favorite tool.png"}}),_v(" "),_c('img',{attrs:{"src":"/test_site/sub_site/images/I'm not allowed to use my favorite tool.png"}}),_v(" "),_c('img',{attrs:{"src":"https://dummyimage.com/600x400/000/fff"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Anchor:\n"),_c('a',{attrs:{"href":"https://dummyimage.com/600x400/000/fff"}},[_v("External Image")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"/test_site/sub_site/images/I'm%20not%20allowed%20to%20use%20my%20favorite%20tool.png"}},[_v("Link to picture")]),_v(" "),_c('a',{attrs:{"id":"namedAnchor"}},[_v("Named Anchor")]),_v(" "),_c('a',[_v("Anchor with no attributes")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include nested sub-site directly")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include nested sub-site from sub-site")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include a file using baseUrl")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include a file in a sub-folder that uses baseUrl")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('div',[_v("Requirements gathering, requirements elicitation, requirements analysis,\nrequirements capture are some of the terms commonly **and** interchangeably used to represent the activity\nof understanding what a software product should do.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include a file in a sub-folder that uses baseUrl using baseUrl")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('div',[_v("Requirements gathering, requirements elicitation, requirements analysis,\nrequirements capture are some of the terms commonly **and** interchangeably used to represent the activity\nof understanding what a software product should do.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include a file in a sub-site that uses baseUrl")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('div',[_c('img',{attrs:{"src":"/test_site/sub_site/images/I'm not allowed to use my favorite tool.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include a file in a sub-site that uses baseUrl using baseUrl")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('div',[_c('img',{attrs:{"src":"/test_site/sub_site/images/I'm not allowed to use my favorite tool.png"}})])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Before | "),_c('span',[_v("Fragment with leading spaces and newline")]),_v(" | After")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Include with custom variables")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_c('strong',[_v("Test included variable as include attribute")])]),_v(" "),_c('p',[_v("Included variable as include attribute")]),_v(" "),_c('p',[_c('strong',[_v("Test included variable")])]),_v(" "),_c('p',[_v("Included variable")]),_v(" "),_c('p',[_c('strong',[_v("Test included variable with markdown")])]),_v(" "),_c('p',[_c('strong',[_c('strong',[_v("Included variable with markdown")])])]),_v(" "),_c('p',[_c('strong',[_v("Test included variable as attribute")])]),_v(" "),_c('p',{staticStyle:{"color":"blue"}},[_v("Test")]),_v(" "),_c('p',[_c('strong',[_v("Test included variable as html element")])]),_v(" "),_c('p',[_c('span',[_v("Included variable within html element")])]),_v(" "),_c('p',[_c('strong',[_v("Test included variable overridden by "),_c('a',{attrs:{"href":"http://variables.md"}},[_v("variables.md")])])]),_v(" "),_c('p',[_v("Global Variable Overriding Included Variable")]),_v(" "),_c('p',[_c('strong',[_v("Test included variables in included file")])]),_v(" "),_c('div',[_c('p',[_v("Included variable in outer included file")]),_v(" "),_c('p',[_v("Included variable overriding inner variable")])]),_v(" "),_c('p',[_c('strong',[_v("Inner included variables should not leak into other files")])]),_v(" "),_c('div',[_c('p',[_v("Should be blank:")])]),_v(" "),_c('p',[_c('strong',[_v("Test included variable with global variable")])]),_v(" "),_c('p',[_v("Included variable with Global Variable")]),_v(" "),_c('p',[_c('strong',[_v("Test nunjucks set overridden by include variable and global variable")])]),_v(" "),_c('p',[_v("Included variable\nGlobal Variable")]),_v(" "),_c('p',[_c('strong',[_v("Test nunjucks import overridden by include variable and global variable")])]),_v(" "),_c('p',[_v("Included variable\nGlobal Variable")]),_v(" "),_c('p',[_c('strong',[_v("Test nunjucks set overridden by include variable and global variable in nested include")])]),_v(" "),_c('p',[_v("Included variable\nGlobal Variable")]),_v(" "),_c('p',[_c('strong',[_v("Test nunjucks import overridden by include variable and global variable in nested include")])]),_v(" "),_c('p',[_v("Included variable\nGlobal Variable")]),_v(" "),_c('p',[_c('strong',[_v("Test missing variable with default")])]),_v(" "),_c('p',[_v("Missing Variable")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Variables for includes should not be recognised as page variables, hence, there should be no text between "),_c('strong',[_v("this")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("and "),_c('strong',[_v("this")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Included variables should not leak into other files")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_v("Should be blank:")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Panel with shorthand heading syntax")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Panel without src")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Panel with normal src")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Panel with src from a page segment")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Panel with boilerplate")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Nested panel")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Nested panel without src")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Panel with src from another Markbind site")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Modal with panel inside")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Unexpanded panel")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test search indexing")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test PlantUML live reload without include")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test PlantUML live reload with include")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("PlantUML Test")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Sequence Diagram")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case Diagram")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Class Diagram")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test PlantUML in sub folder")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Activity Diagram")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Component Diagram")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("State Diagram")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Object Diagram")])])}
},function anonymous(
) {
with(this){return _c('h2',{staticClass:"no-index",attrs:{"id":"level-2-header-inside-headingsearchindex-with-no-index-attribute-should-not-be-indexed"}},[_c('span',{staticClass:"anchor",attrs:{"id":"level-2-header-inside-headingsearchindex-with-no-index-attribute-should-not-be-indexed"}}),_v("Level 2 header (inside headingSearchIndex) with no-index attribute should not be indexed"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#level-2-header-inside-headingsearchindex-with-no-index-attribute-should-not-be-indexed","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h6',{staticClass:"always-index",attrs:{"id":"level-6-header-outside-headingsearchindex-with-always-index-attribute-should-be-indexed"}},[_c('span',{staticClass:"anchor",attrs:{"id":"level-6-header-outside-headingsearchindex-with-always-index-attribute-should-be-indexed"}}),_v("Level 6 header (outside headingSearchIndex) with always-index attribute should be indexed"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#level-6-header-outside-headingsearchindex-with-always-index-attribute-should-be-indexed","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test nunjucks raw tags")])])}
},function anonymous(
) {
with(this){return _c('span',{attrs:{"data-mb-slot-name":"content"}},[_c('div',[_c('p',[_v("Here is the footnote. Footnotes will appear at the bottom of the page.")])])])}
},function anonymous(
) {
with(this){return _c('span',{attrs:{"data-mb-slot-name":"content"}},[_c('div',[_c('p',[_v("Here's one with multiple blocks.")]),_v(" "),_c('p',[_v("Subsequent paragraphs are indented to show that they\nbelong to the previous footnote.")])])])}
},function anonymous(
) {
with(this){return _c('span',{attrs:{"data-mb-slot-name":"content"}},[_c('div',[_c('p',[_v("Inlines notes are easier to write, since\nyou don't have to pick an identifier and move down to type the\nnote.")])])])}
},function anonymous(
) {
with(this){return _c('li',{staticClass:"footnote-item",attrs:{"id":"fn-1-1"}},[_c('p',[_v("Here is the footnote. Footnotes will appear at the bottom of the page.")])])}
},function anonymous(
) {
with(this){return _c('li',{staticClass:"footnote-item",attrs:{"id":"fn-1-2"}},[_c('p',[_v("Here's one with multiple blocks.")]),_v(" "),_c('p',[_v("Subsequent paragraphs are indented to show that they\nbelong to the previous footnote.")])])}
},function anonymous(
) {
with(this){return _c('li',{staticClass:"footnote-item",attrs:{"id":"fn-1-3"}},[_c('p',[_v("Inlines notes are easier to write, since\nyou don't have to pick an identifier and move down to type the\nnote.")])])}
},function anonymous(
) {
with(this){return _c('nav',{staticClass:"fixed-header-padding",attrs:{"id":"page-nav"}},[_c('div',{staticClass:"nav-component slim-scroll"},[_c('a',{staticClass:"navbar-brand page-nav-title",attrs:{"href":"#"}},[_v("Testing Page Navigation")]),_v(" "),_c('nav',{staticClass:"nav nav-pills flex-column my-0 small no-flex-wrap",attrs:{"id":"mb-page-nav"}},[_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#heading-with-multiple-keywords"}},[_v("Heading with multiple keywords‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#heading-with-keyword-in-panel"}},[_v("Heading with keyword in panel‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#panel-with-heading"}},[_v("Panel with heading‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#panel-without-heading-with-keyword"}},[_v("Panel without heading with keyword‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#keyword-should-be-tagged-to-this-heading-not-the-panel-heading"}},[_v("Keyword should be tagged to this heading, not the panel heading‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#panel-with-heading-with-keyword"}},[_v("Panel with heading with keyword‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#heading-with-included-keyword"}},[_v("Heading with included keyword‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#included-heading"}},[_v("Included Heading‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#heading-with-nested-keyword"}},[_v("Heading with nested keyword‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#heading-with-hidden-keyword"}},[_v("Heading with hidden keyword‎")]),_v(" "),_c('nav',{staticClass:"nav nav-pills flex-column my-0 nested no-flex-wrap"},[_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#establishing-requirements"}},[_v("Establishing Requirements‎")]),_v(" "),_c('nav',{staticClass:"nav nav-pills flex-column my-0 nested no-flex-wrap"},[_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#brainstorming"}},[_v("Brainstorming‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#user-surveys"}},[_v("User surveys‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#focus-groups"}},[_v("Focus groups‎")])])]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#path-within-the-boilerplate-folder-is-separately-specified"}},[_v("Path within the boilerplate folder is separately specified‎")]),_v(" "),_c('nav',{staticClass:"nav nav-pills flex-column my-0 nested no-flex-wrap"},[_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#feature-list"}},[_v("Feature list‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#panel-without-src-header"}},[_v("Panel without src header‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#panel-with-normal-src-header"}},[_v("Panel with normal src header‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#panel-with-src-from-a-page-segment-header"}},[_v("Panel with src from a page segment header‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#boilerplate-referencing"}},[_v("Boilerplate referencing‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#referencing-specified-path-in-boilerplate"}},[_v("Referencing specified path in boilerplate‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#outer-nested-panel"}},[_v("Outer nested panel‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#outer-nested-panel-without-src"}},[_v("Outer nested panel without src‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#inner-panel-header-without-src"}},[_v("Inner panel header without src‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#panel-with-src-from-another-markbind-site-header"}},[_v("Panel with src from another Markbind site header‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#panel-with-src-from-another-markbind-site-header-2"}},[_v("Panel with src from another Markbind site header‎")]),_v(" "),_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#unexpanded-panel-header"}},[_v("Unexpanded panel header‎")]),_v(" "),_c('nav',{staticClass:"nav nav-pills flex-column my-0 nested no-flex-wrap"},[_c('a',{staticClass:"nav-link py-1",attrs:{"href":"#level-6-header-outside-headingsearchindex-with-always-index-attribute-should-be-indexed"}},[_v("Level 6 header (outside headingSearchIndex) with always-index attribute should be indexed‎")])])])])])])}
},function anonymous(
) {
