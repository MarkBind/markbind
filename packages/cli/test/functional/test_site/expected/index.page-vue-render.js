...
with(this){return _c('p',[_c('strong',[_v("Test "),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("<markdown>")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("<md>")]),_v(" elements")])])}
},function anonymous(
) {
with(this){return _c('div',[_c('p',[_v("This should be wrapped in a "),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("<p>")]),_v(" tag as it uses the block-level markdown renderer")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"mt-2"},[_c('pre',[_c('code',{pre:true,attrs:{"class":"line-numbers hljs"}},[_c('span',[_v("<markdown> elements allow block-level markdown without needing a leading newline.\n")]),_c('span',[_v("Hence, the contained markdown should be parsed and output as is, without any parsing errors.\n")]),_c('span',[_v("</invalidhtml>\n")])])])])}
},function anonymous(
) {
with(this){return _c('span',[_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("<md>")]),_v(" elements allow inline-level markdown even in a non-markdown token.\nHence, the contained markdown should be parsed and output as is, without any parsing errors.\n"),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("</invalid>")]),_v(".\n")])}
},function anonymous(
) {
...
with(this){return _c('h1',{attrs:{"id":"heading-fragment-with-leading-spaces-and-newline"}},[_c('span',{staticClass:"anchor",attrs:{"id":"heading-fragment-with-leading-spaces-and-newline"}}),_v("Heading "),_c('div',[_c('pre',[_c('code',{pre:true,attrs:{"class":"line-numbers undefined"}},[_v("Fragment with leading spaces and newline\n")])])]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#heading-fragment-with-leading-spaces-and-newline","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("id")]),_v(" for the above heading should be "),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("heading-fragment-with-leading-spaces-and-newline")]),_v(" in total.\nThis test ensures heading ids are assigned last (e.g. after "),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("<include />")]),_v("s are processed).")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Also, the boilerplate file name (e.g. "),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("inside.md")]),_v(") and the file that it is supposed to act as ("),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("notInside.md")]),_v(") can be different.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("This file should behaves as if it is in the "),_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("requirements")]),_v(" folder:")])}
},function anonymous(
) {
...
with(this){return _c('div',[_c('p',[_c('code',{pre:true,attrs:{"class":"line-numbers hljs inline no-lang"}},[_v("MarkBind supports .mbdf files.")])])])}
},function anonymous(
) {
