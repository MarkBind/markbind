...
<li class="site-nav-custom-list-item site-nav-list-item-2">Line break item 2 📘</li>
  ...
  <div id="content-wrapper">
    ...
    <p><strong>Default contact us form</strong></p>
<box class="web3Form" type="info" no-icon><p class="h2">Contact Us</p><form onsubmit="submitForm(this)"><input type="hidden" name="access_key" value><label for="name">Name</label>
<input type="text" name="name" required placeholder="John Doe">
<label for="email">Email</label>
<input type="email" name="email" required placeholder="johndoe@gmail.com">
<label for="message">Message</label>
<textarea name="message" required></textarea>
<button type="submit" class="badge bg-info">Submit</button></form></box>
<p><strong>Form with default inputs</strong></p>
<box class="web3Form" type="info" no-icon>



<form onsubmit="submitForm(this)"><input type="hidden" name="access_key" value><label for="name">Name</label>
<input type="text" name="name" required placeholder="John Doe"><label for="message">Message</label>
<textarea name="message" required></textarea><button type="submit" class="badge bg-info">Submit</button></form></box>
<p><strong>Form with customised inputs</strong></p>
<box class="web3Form" type="info" no-icon>
...
<form onsubmit="submitForm(this)"><input type="hidden" name="access_key" value><input type="radio" id="html" name="fav_language" value="HTML"><label for="html">HTML</label><br><input type="radio" id="css" name="fav_language" value="CSS"><label for="css">CSS</label><br><input type="radio" id="javascript" name="fav_language" value="JavaScript"><label for="javascript">JavaScript</label><br><input list="browsers"><datalist id="browsers">
    <option value="Internet Explorer"></option><option value="Firefox"></option><option value="Chrome"></option><option value="Opera"></option><option value="Safari"></option></datalist><br><button type="submit" class="badge bg-info">Submit</button></form></box>
<p><strong>Form with customised options</strong></p>
<box type="warning" class="web3Form" no-icon><h3 id="i-am-a-header">🚀 I am a header<a class="fa fa-anchor" href="#i-am-a-header" onclick="event.stopPropagation()"></a></h3>
<form onsubmit="submitForm(this)"><input type="hidden" name="access_key" value><label for="name">Name</label>
<input type="text" name="name" required placeholder="John Doe">
<label for="email">Email</label>
<input type="email" name="email" required placeholder="johndoe@gmail.com">
