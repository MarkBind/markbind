...
with(this){return _c('p',[_v("An material icon is supposed to appear here ---> "),_c('span',{staticClass:"material-icons-round align-middle",attrs:{"aria-hidden":"true"}},[_v("perm_media")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("There is one material-icons icon in this page content.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Open up console. Only material-icons stylesheet should be loaded!")])])}
}];
