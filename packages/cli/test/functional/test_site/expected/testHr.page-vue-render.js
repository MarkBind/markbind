...
<li class="site-nav-custom-list-item site-nav-list-item-2">Line break item 2 📘</li>
  ...
  <div id="content-wrapper">
    ...
    <h1 id="different-types-of-horizontal-rules">Different types of horizontal rules<a class="fa fa-anchor" href="#different-types-of-horizontal-rules" onclick="event.stopPropagation()"></a></h1>
<hr>
<hr class="dotted">
<hr class="dashed">
<hr class="double">
...
<hr class="dashed thick-3">
<hr class="double border-secondary">
<hr class="dotted thick-1 border-primary">
  </div>
