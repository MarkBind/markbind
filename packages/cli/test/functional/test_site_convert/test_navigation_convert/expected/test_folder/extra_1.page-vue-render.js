...
<li><div class="site-nav-default-list-item site-nav-list-item-0" onclick="handleSiteNavClick(this)"><a href="/test_folder/extra_3.html">Extra 3</a></div></li>
  ...
  <div id="content-wrapper">
    ...
    <h1 id="sample-content-in-another-folder-which-is-not-named-content">Sample content in another folder which is not named content<a class="fa fa-anchor" href="#sample-content-in-another-folder-which-is-not-named-content" onclick="event.stopPropagation()"></a></h1>
  </div>
