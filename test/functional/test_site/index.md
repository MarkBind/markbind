...
<variable name="page_global_variable_overriding_page_variable">**TEST FAIL**: Page Variable overridden by Global Variable</variable>
...
<include src="testIncludeVariables.md" var-included_variable_as_include_attribute="Included variable as include attribute">
  ...
  <span id="global_variable_overriding_included_variable">**TEST FAIL**: Included variable overridden by global variable</span>
  ...
  <span id="included_variable_should_not_leak">**TEST FAIL**: Included variable should not leak into other files</span>
