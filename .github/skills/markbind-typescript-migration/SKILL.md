...
1. Determine work scope and order
1. Seek approval from team before starting
...
5. Update package.json to add tsc compilation step if needed
6. Run tests (npm run setup && npm run test && npm run lintfix)
7. Commit normally
