...
However, toggling-on this option allows the user to edit the post-build HTML files in a friendly manner (through proper indentation of the code, for example). 
<br>
To toggle on the option, add the following to `site.json` - 
```js
...
"htmlBeautify": true,
...
