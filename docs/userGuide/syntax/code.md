...
g | <span style="display:inline-block; width:20px; height:20px; background:rgb(0 255 0 / 70%); border-radius:3px; margin-right:5px;"></span> Neon green         | <span style="display:inline-block; width:20px; height:20px; background:rgb(5 102 0 / 70%); border-radius:3px; margin-right:5px;"></span> Forest green
...
y | <span style="display:inline-block; width:20px; height:20px; background:rgb(255 255 0 / 70%); border-radius:3px; margin-right:5px;"></span> Bright yellow    | <span style="display:inline-block; width:20px; height:20px; background:rgb(150 140 0 / 70%); border-radius:3px; margin-right:5px;"></span> Golden yellow
...
w | <span style="display:inline-block; width:20px; height:20px; background:rgb(255 255 255 / 100%); border-radius:3px; margin-right:5px;"></span> White         | <span style="display:inline-block; width:20px; height:20px; background:rgb(150 150 150 / 50%); border-radius:3px; margin-right:5px;"></span> Silver grey
