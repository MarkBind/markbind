...
Patching          | <ul><li>Quick - no need to maintain / publish more npm packages or setup release procedures etc</li><li>Ensure the changes propagate to other dependencies</li><li>Benefits of a monorepo</li></ul> | <ul><li>Difficult to upgrade</li></ul>                              
