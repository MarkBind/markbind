...
1. **If vue-components package bundle was updated earlier**: also ensure that the minified `components.min.js` is copied to each of the expected test site's folders.
